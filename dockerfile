...
RUN chmod 644 /usr/local/etc/php/conf.d/local.ini

# Berikan permission yang benar
RUN chown -R www-data:www-data /var/www \
    && chmod -R 755 /var/www

# Install PHP 8.2 terbaru
RUN apt-get install -y php8.2 php8.2-fpm php8.2-cli php8.2-mysql php8.2-mbstring php8.2-xml php8.2-zip php8.2-bcmath php8.2-gd php8.2-curl php8.2-opcache
